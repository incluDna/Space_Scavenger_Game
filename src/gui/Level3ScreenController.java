...
// Controls the UI for Level 3 screen
public class Level3ScreenController {
	@FXML
	...
	// Initializes the Level 3 screen
	@FXML
	public void initialize() {
		System.out.println("Level 3 Started"); // Debug log
		...
		btnPlayAgain.setOnAction(event -> {
			...
			GameManager.startGame(gui.SceneManager.getPrimaryStage(), 3); // Restarts Level 3
		});
